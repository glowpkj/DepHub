...
local featurePaths = {
    PlayerESP = "src/games/bloxfruits/features/playeresp.lua",
    FruitESP = "src/games/bloxfruits/features/fruit.lua",
    ObservationHaki = "src/games/bloxfruits/features/observation.lua",
    UnbreakableAll = "src/games/bloxfruits/features/unbreakable.lua",
    CameraShake = "src/games/bloxfruits/features/camerashake.lua"
}
local features = {}
