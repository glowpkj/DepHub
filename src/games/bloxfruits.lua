...
function State:CreateUI()
    ...
    Combat:CreateLabel("SILENT AIM")
    Combat:CreateLabel("Interceptações de metamethod e alteração de remotes de jogos de terceiros não são habilitadas neste framework.")
    Combat:CreateDivider("MOVEMENT")
